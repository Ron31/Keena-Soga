...
setInterval(async function() {
    ...
    let status = [`${BotSettings.prefix}help`, `${bot.users.size} members!`,`${bot.guilds.size} Servers!`,`Developer: ${bot.users.get(BotSettings.OwnerID).username}#${bot.users.get(BotSettings.OwnerID).discriminator}`,`your commands`];
    ...
    if(message.content ==`${BotSettings.prefix}userafk`) {
       ...
       if(message.content ==`${BotSettings.prefix}serverinfo`) {
        ...
        // });
            ...
            .addField(`Owner`,`${message.guild.owner} (${message.guild.owner.id})`,true)
