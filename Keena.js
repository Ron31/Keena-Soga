...
bot.on("message", async message => {
    ...
    //Verbotene Zeichen/Wörter
     ...
     if(!message.author.bot) {
        ...
        if(message.content ==`${BotSettings.prefix}help`) { 
            ...
            .addField(`**__Info__**`,"`userinfo`,`serverinfo`,`serverlist`,`nicknames`,`userafk`,`messages`,`devmessage`,`botinfo`,`botinvite`,`Hypesquad`",true)
    ...
    if(message.content ==`${BotSettings.prefix}userafk`) {
        ...
        if(message.content.startsWith(`${BotSettings.prefix}clear`)) {
            ...
            message.reply(`**${member.user.username}#${member.user.discriminator}** was kicked off the server for **__${reason}__**`);
            ...
            message.reply(`**${member.user.username}#${member.user.discriminator}** was banned off the server for **__${reason}__**`);
