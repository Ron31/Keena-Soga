...
bot.on("message", async message => {
    ...
    var args = message.content.slice(BotSettings.prefix.length).trim().split(" "),
        ...
        HelpMod = `https://cdn.discordapp.com/attachments/406957187869442048/493389434612350978/loadhelp.gif`
        Help = `Help`
     ...
     if(!message.author.bot) {
      ...
      if(message.content ==`${BotSettings.prefix}join`) {
        ...
        if(message.content ==`${BotSettings.prefix}help lööps`) {
            var embed = new Discord.RichEmbed()
            .setColor("#7289DA")
            .addField(`lööps`,"`Shows the pros and cons of the brands in Splatoon 2`",false)
            .setFooter(Help, AuthorFooter)
            .setThumbnail(HelpIcon)
