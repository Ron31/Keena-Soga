...
bot.on("message", async message => {
    ...
    let Bot = message.guild.emojis.find("name","botTag")
    ...
    //Verbotene Zeichen/Wörter
     ...
     if(!message.author.bot) {
        ...
        if(message.content ==`${BotSettings.prefix}help`) { 
            ...
            .addField(`**__Info__**`,"`userinfo`,`serverinfo`,`serverlist`,`membercount`,`messages`,`botinfo`",true)
            ...
            .addField(`**__No Category__**`,"`rolecolor`,`randomcolor`,`devmessage`,`botinvite`,`Hypesquad`")
      ...
      if(message.content ==`${BotSettings.prefix}join`) {
        ...
        if(message.content ==`${BotSettings.prefix}help messages`) {
            ...
            .addField(`Usage`,`**${BotSettings.prefix}messages** or **${BotSettings.prefix}messages [member]**`)
            .setFooter(Help, KeenaLogo)
            .setThumbnail(HelpIcon)
