...
bot.on("message", async message => {
    ...
    var args = message.content.slice(BotSettings.prefix.length).trim().split(" "),
        ...
        HelpMod = `https://cdn.discordapp.com/attachments/406957187869442048/492694413152354334/help_mod.png`
        Help = `Help`
    ...
    //Verbotene Zeichen/Wörter
     ...
     if(!message.author.bot) {
        ...
        if(message.content ==`${BotSettings.prefix}help`) { 
            ...
            .addField(`**__Info__**`,"`userinfo`,`serverinfo`,`serverlist`,`membercount`,`messages`,`devmessage`,`botinfo`,`botinvite`,`Hypesquad`",true)
            ...
            .setThumbnail("https://cdn.discordapp.com/attachments/406957187869442048/492693654310486016/help_button.png")
        ...
        if(message.content ==`${BotSettings.prefix}Hypesquad`) {
            ...
            .addField("If you want to change your house. Can you do that. ","All you have to do is type the same as above, only with a **leave** behind. That would look like that: `ks!Balanceleave`",true)
      ...
      if(message.content ==`${BotSettings.prefix}join`) {
        ...
        if(message.content ==`${BotSettings.prefix}help emojiFile`) {
            ...
            .addField(`Usage`,`**__${BotSettings.prefix}emojiFile [Emojiname]__**`)
            .setFooter(Help, KeenaLogo)
            .setThumbnail(HelpIcon)
        ...
        if(message.content ==`${BotSettings.prefix}help rolecolor`) {
            ...
            .addField(`Usage`,`**__${BotSettings.prefix}rolecolor [Rolename]__**`)
            .setFooter(Help, KeenaLogo)
            .setThumbnail(HelpIcon)
        ...
        if(message.content ==`${BotSettings.prefix}help roleedit`) {
            ...
            .addField(`Usage`,`**__${BotSettings.prefix}roleedit [Rolename] [Colorcode]__**`)
            .setFooter(Help, yes)
            .setThumbnail(HelpMod)
       ...
       if(message.content ==`${BotSettings.prefix}serverinfo`) {
        ...
        if(message.content ==`${BotSettings.prefix}membercount`) {
            ...
            .setFooter(NewtoxDev, ServerIcon)
            .setThumbnail(`https://cdn.discordapp.com/attachments/406957187869442048/493066518884515841/memberIcon-0001.png`)
