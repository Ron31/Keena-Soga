...
bot.on("ready", async () => {
    ...
    if(message.content ==`${BotSettings.prefix}Userinfo`) {
        ...
        embed.addField("Account erstellt am", `${message.author.createdAt.toString().split(" ")[2]} ${message.author.createdAt.toString().split(" ")[1]} ${message.author.creadetAt.toString().split(" ")[3]}`, false) 
